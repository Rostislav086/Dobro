<template>
  <div>
    <div class="my tabs-content" id="tabs-content__1">
      <div class="my-top">
        <a href="#" class="my-top__link">Активные</a>
        <a href="#" class="my-top__link">Архив</a>
        <router-link to="/fonds" class="my-top__link top-link__btn">Создать марафон</router-link>
      </div>
      <!-- /.my-top -->
      <!--            <div class="my-news">-->
      ...
      <!--                        <div class="news">-->
      <!--                            <p class="news-title">-->
      <!--                                *ИМЯ* внёс 10 000 р. на счёт вашего марафона-->
      <!--                                “Сохраним лес”-->
      <!--                            </p>-->
      <!--                            <a href="#" class="news-description">Подробнее</a>-->
      <!--                            <a href="#" class="news-display">Скрыть</a>-->
      <!--                        </div>-->
      <!--                    </swiper-slide>-->
      <!--                    <swiper-slide>-->
      <!--                        <div class="news">-->
      ...
      <div class="my-marathon">
        <div class="my-marathon__block" v-for="marathon in marathons" :key="marathon.id">
          <div class="item">
            <div class="item-top">
              <p class="item-top__title">{{ marathon.name }}</p>
            </div>
